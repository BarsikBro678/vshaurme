...
Проект работает на [Django 1.11.1](https://docs.djangoproject.com/en/4.1/releases/1.11/). 
Сейчас очень нужна помощь с моделированием системы, почитать о котором можно [здесь](https://docs.djangoproject.com/en/1.11/intro/tutorial02/#ceating-models).
